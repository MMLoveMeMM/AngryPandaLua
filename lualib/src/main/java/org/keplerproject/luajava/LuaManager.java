...
public class LuaManager {
    ...
    public void init(Context context) {
        ...
        //定义文件夹
        odexDir = getSDPath();//context.getDir("odex", Context.MODE_PRIVATE).getAbsolutePath();
        libDir = getSDPath();//context.getDir("lib", Context.MODE_PRIVATE).getAbsolutePath();
        luaDir = getSDPath();//context.getDir("lua", Context.MODE_PRIVATE).getAbsolutePath();
        ...
        Log.d("LuaManager", "luaLpath : " + luaLpath);
    }
